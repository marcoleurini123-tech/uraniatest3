...
def render_page1():
    ...
    # ==========================================================
    # MATRICE HEATMAP (MODIFICATA PER ISOLARE IN BIANCO IL VINCITORE)
    # ==========================================================
    ...
    if not df_matrix.empty:
        ...
        # OVERRIDE: Spinge la riga del regime dominante fuori dalla scala a un valore di 2.0
        ...
        for r in df_matrix.index:
            ...
            for c in df_matrix.columns:
                ...
                # Grassetto per i numeri della riga dominante
        ...
        fig_hm = go.Figure(data=go.Heatmap(
            ...
            colorscale=[
                ...
                [1.00, '#ffffff']  # Il 2.0 impostato sopra si trasforma in Bianco puro
            ],
            zmin=0.0,
